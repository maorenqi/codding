...
if(isset($_REQUEST['val_1']) && isset($_REQUEST['val_2'])){
	...
	$val_3 = trim($_REQUEST['val_3']) ? stripslashes($_REQUEST['val_3']) : '';
	
	//$all = stristr($gethtml,$str_start);
...
echo <<<EOD
	...
	<hr></hr>
	<span><strong>需要替换或搜寻的参数</strong>：</span><br />
	<textarea name="val_1" rows="8" cols="50" id="val_1">{$val_1}</textarea><br/>
	<hr></hr>
	<span><strong>替换后的参数</strong>：</span><br />
	<textarea name="val_2" rows="8" cols="50" id="val_2">{$val_2}</textarea><br/>
	<hr></hr>
	<span>清除该字符串后面的所有数据：</span><br />
	<textarea name="val_3" rows="8" cols="50" id="val_3">{$val_3}</textarea><br/>
	
	当前目录:<input type="radio" name="dir" value="1" /><br/>
	当前目录下的所有目录:<input type="radio" name="dir" value="2" checked  /><br/>
